...
const Project = () => {
    ...
    return (
        <div>
            ...
            <div  data="fade-up-right" className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 '>

                <div class="card w-96 bg-base-100 shadow-xl" data-aos="flip-left" >
                ...
                <div data-aos="flip-left" class="card w-96 bg-base-100 shadow-xl duration-150">
                    <figure class="px-10 pt-10">
                ...
                <div data-aos="flip-left" class="card w-96 bg-base-100 shadow-xl">
                    <figure class="px-10 pt-10">
